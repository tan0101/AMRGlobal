            ...
            for count_indicator, indicator in enumerate(indicators_df.columns[2:]):
                ...
                for row in curve_df.index:
                    ...
                    if curve_df.loc[row]['Result'] == 'Linear curve fitted':
                        ...
                        df.to_csv('Results/Forecasting Global/MonteCarloIndicatorForecasts/IndicatorForecast_montecarlosimulations_'+specie+'_'+class_name+'_Indicator_'+str(IndicatorBounds.loc[indicator,"Code"])+ '.csv')

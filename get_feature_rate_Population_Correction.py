...
if __name__ == "__main__":
    ...
    dict_clf = {
        "Acinetobacter_baumannii": 3,
        "Clostridioides_difficile": 3,
        "Corynebacterium_diphtheriae": 4, 
        ...
        "Shigella_flexneri": 0,
        "Shigella_sonnei": 3, 
        "Staphylococcus_aureus": 3,
        "Streptococcus_agalactiae": 4,
        "Streptococcus_suis": 4,
        "Streptococcus_pneumoniae": 4,
        "Mycobacterium_tuberculosis": 0,
        "Neisseria_gonorrhoeae": 6
    }
    ...
    writer = pd.ExcelWriter("Results/Feature Rate/"+specie_name+"_test.xlsx", engine='xlsxwriter')
    ...
    for count, class_name in enumerate(class_RSI_df.columns):
        ...
        for name_antibiotic in amr_df.columns:
            ...
            # Get features
            performance_file = "Results/"+specie_name+" AMR PA/Population Correction/SMOTE_results_"+specie_name+"_"+name_antibiotic_test+".csv"
            ...
            if performance_array[dict_clf[specie_name]] < 0.9:
                continue

            print(performance_file)

            # Get features
            features_file = "Results/"+specie_name+" AMR PA/Population Correction/features_"+specie_name+"_"+name_antibiotic_test+".csv"                
